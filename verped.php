...
<div class="container-fluid" style="border-bottom: 1px">
	...
	<div class="container">
		...
		<div class="col-md-2 column margintop20">
		  ...
		  <li class="active"><a href="carrito.php"><span class="glyphicon glyphicon-chevron-right"></span> Compra</a></li>
		  <li><a href="historial.php"><span class="glyphicon glyphicon-chevron-right"></span>Historial</a></li>
