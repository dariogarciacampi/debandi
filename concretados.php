...
<body> 
	...
	<div class="container">
		...
		<div class="col-md-2 column margintop20">
		  ...
		  <li class="active"><a href="concretados.php"><span class="glyphicon glyphicon-chevron-right"></span> Confirmados</a></li>
		</ul>
		</div>
		<div class="col-md-10">
			<div class="col-xs-12">
		...
		<div id="listaarticulos">
			<?php
				...
				$carrito =  mysqli_query($conectado,"SELECT CodiPedi,TTotPedi,FechPedi, EmprUsua, NombLoca, NombProv FROM pedido INNER JOIN usuario ON usuario.CodiUsua = pedido.CodiUsua INNER JOIN localidad ON localidad.CodiLoca = usuario.CodiLoca INNER JOIN provincia ON provincia.CodiProv = localidad.CodiProv WHERE pedido.EstaPedi = 'Concretado' ORDER BY CodiPedi DESC");
								...
								echo "No hay pedidos Concretados";
